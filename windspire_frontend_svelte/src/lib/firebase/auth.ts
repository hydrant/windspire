...
export class FirebaseAuthService {
    ...
    async signInWithGoogle(): Promise<UserCredential | null> {
        if (!browser || !auth) {
            console.warn('Firebase auth not available - either not in browser environment or Firebase not properly initialized');
        ...
        try {
            ...
            if (error.code === 'auth/operation-not-allowed') {
                ...
                throw new Error('This domain is not authorized for OAuth operations. Please add your domain to the Firebase Console under Authentication > Settings > Authorized domains.');
    ...
    async signUpWithEmail(email: string, password: string, displayName?: string): Promise<UserCredential> {
        ...
        try {
            ...
            if (error.code === 'auth/email-already-in-use') {
                ...
                throw new Error('Email/password authentication is not enabled. Please enable it in the Firebase Console.');
            }
